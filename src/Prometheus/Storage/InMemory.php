...
class InMemory implements Adapter
{
     ...
     * @return MetricFamilySamples[]
     */
    protected function collectSummaries()
    {
        $math = new Math();
        $summaries = [];
     ...
     * @return MetricFamilySamples[]
     */
    protected function internalCollect(array $metrics)
    {
        $result = [];
     ...
     * @return string
     */
    protected function histogramBucketValueKey(array $data, $bucket)
    {
        return implode(':', [
            $data['type'],
            $data['name'],
     ...
     * @return string
     */
    protected function metaKey(array $data)
    {
        return implode(':', [
            $data['type'],
            $data['name'],
     ...
     * @return string
     */
    protected function valueKey(array $data)
    {
        return implode(':', [
            $data['type'],
            $data['name'],
     ...
     * @return mixed[]
     */
    protected function metaData(array $data)
    {
     ...
     */
    protected function encodeLabelValues(array $values)
    {
     ...
     * @throws RuntimeException
     */
    protected function decodeLabelValues($values)
    {
